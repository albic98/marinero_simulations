...
class Pose_Z_Offset(Node):
    def __init__(self):
        ...
        # self.estimate_pose_subsriber = self.create_subscription(PoseWithCovarianceStamped, "/initial_pose", self.pose_callback, 10)
        self.goal_pose_publisher = self.create_publisher(PoseStamped, "/goal_pose", 10)
        # self.estimate_pose_publisher = self.create_publisher(PoseWithCovarianceStamped, "/initial_pose", 10)
    ...
    #     estimate_pose.pose.pose.position.x = initial_estimate_pose.pose.position.x
    #     estimate_pose.pose.pose.position.y = initial_estimate_pose.pose.position.y
    #     estimate_pose.pose.pose.position.z = self.marina_dock_height
    #     estimate_pose.pose.orientation = initial_estimate_pose.pose.orientation
